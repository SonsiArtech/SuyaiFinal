<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SuyaiFinal.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <section class="banner-principal">
    <div>
      <h3 class="titulo-dos">Sobre nosotros</h3>
    </div>
    <div class="parrafo">
      <p class="poema">
